class Admin::EventsController < AdminController
  ...
  def event_params
    params.require(:event).permit(:name, :description, :image, :url, :date, :end_date, :location_name, :location, :instructions, :contact, :campaign_id, :user_id, :htag_list, {task_ids: []})
  end
end
